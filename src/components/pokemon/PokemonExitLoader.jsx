// PokemonExitLoader.jsx
// Tela de saida tematica do PokeSombra.
// Exibida ao clicar em Voltar na tela de selecao de niveis.
// Mostra imagem de fundo, kicker, titulo e subtitulo por ~1800ms antes de navegar para /app.
