...
const MissionSummary = ({
  ...
  return (
    <div className="sw-mission-summary">
      <div className="sw-summary-header">
        <h2 className="sw-summary-title">Relatorio da Missao</h2>
        <p className="sw-summary-subtitle">
          Confira os dados antes de entrar no campo de asteroides.
        </p>
      </div>
      ...
      {effects.length > 0 && (
        <div className="sw-effects-section">
          <h3 className="sw-effects-title">Efeitos da Combinacao</h3>
